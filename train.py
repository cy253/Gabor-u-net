...
from networks.liunet import LIUNet
from networks.LIUnet2 import LIUNet2
from networks.LIunet3 import LIUNet3
...
def train(model,optimizer,scheduler,criterion,train_loader,
    ...
    for e in range(epochs):
        ...
        if val_metrics['loss'] < valid_loss_min:
            ...
            torch.save(save_file, 'results/LIUNet3.pth')
        else:
...
def main(args):
    ...
    model = LIUNet3(in_channels=4,num_classes=4).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='E:\\code\\shenduxuexi\\brats-unet-main\\data\\dataset')
    parser.add_argument('--train_txt', type=str, default='E:\\code\\shenduxuexi\\brats-unet-main\\data\\train.txt')
    parser.add_argument('--valid_txt', type=str, default='E:\\code\\shenduxuexi\\brats-unet-main\\data\\valid.txt')
    parser.add_argument('--test_txt', type=str, default='E:\\code\\shenduxuexi\\brats-unet-main\\data\\test.txt')
    parser.add_argument('--train_log', type=str, default='results/LIUNet3.txt')
    parser.add_argument('--weights', type=str, default='results/LIUNet3.pth')
    parser.add_argument('--save_path', type=str, default='checkpoint/LIUNet3')
